...
function Dashboard() {
    ...
    const [requiredSkills, setRequiredSkills] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [editingId, setEditingId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [showForm, setShowForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const authCheckedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const jobsFetchingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    function clearForm() {
        setTitle("");
        setDescription("");
        setRequiredSkills("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            if (authCheckedRef.current) {
                const cached = ("TURBOPACK compile-time value", "object") !== "undefined" && sessionStorage.getItem("admin_authenticated");
                if (cached === "true") setAuthorized(true);
                return;
            }
            authCheckedRef.current = true;
            const cached_0 = ("TURBOPACK compile-time value", "object") !== "undefined" && sessionStorage.getItem("admin_authenticated");
            if (cached_0 === "true") {
                setAuthorized(true);
                return;
            }
    ...
    async function deleteJob(id) {
        ...
        try {
            const response_0 = await fetch(`/api/jobs/${id}`, {
                method: "DELETE"
            });
            if (!response_0.ok) {
                const errorData_0 = await response_0.json();
                alert(`Error: ${errorData_0.error || "Failed to delete job"}`);
                return;
            }
            try {
                sessionStorage.removeItem("admin_jobs");
            ...
            console.error("Error deleting job:", error_0);
            alert(`Error: ${error_0 instanceof Error ? error_0.message : "Unknown error"}`);
        }
    }
    async function logout() {
        try {
            ...
            console.error("Logout error:", e_1);
        }
        try {
            sessionStorage.removeItem("admin_authenticated");
            sessionStorage.removeItem("admin_jobs");
    ...
    async function fetchJobs() {
        try {
            const cached_1 = sessionStorage.getItem("admin_jobs");
            if (cached_1) {
                setJobs(JSON.parse(cached_1));
                return;
            }
        } catch (e_3) {}
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            onChange: (e_5)=>setRequiredSkills(e_5.target.value),
                                            className: "w-full px-4 py-3 rounded-lg border border-slate-300 bg-white text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard/page.tsx",
                                            lineNumber: 234,
...
_s(Dashboard, "6Nl5WMK2AtGgjDZ7QVo5nKfmj8s=", false, function() {
    return [
...
//# sourceMappingURL=_4e7aaec4._.js.map